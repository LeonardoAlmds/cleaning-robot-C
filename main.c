...
int checkDirectionBase() {
    ...
    bool verifyBaseR = robo.column < SIZE - 1 && (strcmp(matrix[robo.line][robo.column + 1], " E ") == 0);
    bool verifyBaseL = robo.column > 0 && (strcmp(matrix[robo.line][robo.column - 1], " E ") == 0);
    bool verifyBaseD = robo.line < SIZE - 1 && (strcmp(matrix[robo.line + 1][robo.column], " E ") == 0);
...
int checkDirectionTrash() {
    ...
    int verifyR = robo.column < SIZE - 1 && strcmp(matrix[robo.line][robo.column + 1], "@@@") == 0;
    int verifyL = robo.column > 0 && strcmp(matrix[robo.line][robo.column - 1], "@@@") == 0;
    int verifyD = robo.line < SIZE - 1 && strcmp(matrix[robo.line + 1][robo.column], "@@@") == 0;
